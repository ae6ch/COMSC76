/**
 * MyLinkedList.java from textbook with the missing methods added
 * 
 * 11/13/23
...
public class MyLinkedList<E> implements MyList<E> {
  ...
  public boolean contains(Object e) {
    return stream().anyMatch(element -> (e == null && element == null) ||
  ...
  public int indexOf(Object element) {
    ...
    for (int i = 0; i < size; i++) {
      if ((element == null && current.element == null) || (element != null && element.equals(current.element))) {
        return i;
      }
      current = current.next;
    }
  ...
  private class LinkedListIterator
    ...
    private E last = null; // Last index (used by remove() method)
    ...
    @Override
    public E next() {
      // E e = current.element; // need to move last to instance variable since
      // remove() needs to know what was last returned
